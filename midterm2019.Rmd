...
problem set before you begin. This exam consists of 25 problems. The
problems are worth a combined total of 75 points. You have a total of
...
(c) The least square estimate for $\beta_{\mathrm{carat}}$ is negative.
...
NHANES_sml <- NHANES %>% select(Gender, Age, Race1, 
                                Poverty, Weight, Height, BMI, TotChol,Diabetes)
...
**Q4** Which of the following **geom_object** understands all of the following aesthetics $\mathtt{x}$, $\mathtt{ymin}$ and $\mathtt{ymax}$ ?
