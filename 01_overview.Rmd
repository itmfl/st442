...
+ Name: Minh Tang. (Preferred Salutation: Dr. Tang.)
+ Birthplace: Vietnam.
+ Degrees: 
...
knitr::include_graphics("figure/data_never_sleeps.jpg")
```
...
knitr::include_graphics("figure/linkedin_2025.png")
```
---
```{r echo = FALSE, out.width="70%"}
knitr::include_graphics("figure/bls.png")
```
...
knitr::include_graphics("figure/risk_genai.png")
```

Read the [preprint](https://arxiv.org/abs/2507.07935). 
...
```{r out.width = "60%", echo = FALSE, fig.cap = "https://sshaikh.org/2019/06/01/top-skills-for-a-data-scientist-2019/"}
knitr::include_graphics("https://sshaikh.org/wp-content/uploads/2019/06/image-2-1024x1024.png")
```
---
...
Don't panic if you had never use **R**. It is very easy to learn (but hard to master).

First thing first

+ Install base [R](https://cran.r-project.org/mirrors.html) and then install [Rstudio](https://www.rstudio.com/products/rstudio/download/#download). 

+ Read chapter 1 through 3 of [Introduction to Data Science](https://rafalab.dfci.harvard.edu/dsbook-part-1/).
...
+ Chapter $1$ through $6$ of Rafael Irizarry's [Introduction to Data Science](https://rafalab.dfci.harvard.edu/dsbook-part-1/).
...
--
<br><br>
+ Ask your TA [Arpan](https://statistics.sciences.ncsu.edu/people/akumar46) and [Elyse](https://statistics.sciences.ncsu.edu/people/emmcfall).
...
class: clear
### Suggested Texts
+ Garrett Grolemund and Hadley Wickham, [R for Data Science 2nd edition](https://r4ds.hadley.nz)
...
+ Rafael Irizarry's Introduction to Data Science [part 1](https://rafalab.dfci.harvard.edu/dsbook-part-2/) and [part 2]( https://rafalab.dfci.harvard.edu/dsbook-part-2)
...
### Homework policy
The class has, with high probability, 7 -- 8 homework assignments. Every student is allowed a **quota of at most 3 late** homework submissions 
...
class: clear
### Key Dates
+ Census day & drop deadline: Friday, August 29, 2025.
+ Withdrawal deadline: Thursday, October 23, 2025.
+ Take home exam 1: Thursday, September 25, 2025 (tentative)
+ Take home exam 2: Thursday, October 31, 2025. (tentative)
+ Term paper: Due on Friday, December 5, 2025 before 11:59pm (tentative)
