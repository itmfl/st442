...
+ Current Employment: Department of Statistics.
+ Office Hour: 10am -- 12pm Wednesday, or by appointment.
+ Favourite Quote:
...
```{r out.width = "60%", echo = FALSE, fig.cap = "Figure from D. Conway"}
...
+ Chapter $1$ through $4$ of Rafael Irizarry's [Introduction to Data Science](https://bookdown.org/rdpeng/rprogdatascience/)
